...
load_tweets = LOAD '/input/11/' USING com.twitter.elephantbird.pig.load.JsonLoader('-nestedLoad') AS myMap;
...
STORE stripped_tweets INTO '/processed/november.txt' USING PigStorage('\\x0B', '-schema');